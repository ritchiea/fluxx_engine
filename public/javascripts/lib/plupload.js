    ...
    init : function(uploader, callback) {
      ...
      uploader.bind("Init", function(up) {
        ...
        inputContainer.innerHTML = '<input id="' + uploader.id + '_html5" ' +
                      'style="width:100%;height:100%;" type="file"' +
                      //AML: Commenting out the accept attribute for now as it does not seem to allow the uploading
                      //     of xls documents in Chrome 8 on OS X despite which mime type is set and it seems
                      //     to have no effect in Safari.
                      // accept="' + mimes.join(',') + '" ' +
