class Instrument < ActiveRecord::Base
  ...
  acts_as_audited({:full_model_enabled => true, :except => [:created_at, :updated_at], :except => [:created_at, :updated_at, :locked_until, :locked_by_id, :deleted_at, :created_by_id, :updated_by_id], :protect => true})
